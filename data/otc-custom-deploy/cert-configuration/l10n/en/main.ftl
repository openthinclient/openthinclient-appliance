...
page_title = openthinclient Certificate configuration
...
issued_certs_explainer = Certificates are issued automatically when the openthinclient-Management or the Certificate configuration is accessed. Certificates are issued only for the IP addresses and hostname of the openthinclient Appliance.
confirm_cert_deletion = Are you sure you want to delete certificate?
cert_subject = Subject
cert_name = Host
cert_fingerprint = SHA256-Fingerprint

cert_configuration_settings = Settings
reachability_setting = Certificate configuration is accessible only on the appliance
reachability_setting_explainer = If this option is enabled, the Certificate configuration is accessible only locally on the appliance. If the option is disabled, the Certificate configuration can also be accessed from the network.
https_setting = HTTPS Enabled
https_setting_explainer = If this option is enabled, connections to the openthinclient-Management are secured using HTTPS. Requests to port 8080 are automatically redirected to port 443.
settings_save_label = Apply
confirm_reachability_enable = Are you sure you want to make the Certificate configuration only accessible on the appliance?
confirm_reachability_disable = Are you sure you want to make the Certificate configuration also accessible from the network?
confirm_https_enable = Are you sure you want to enable HTTPS?
confirm_https_disable = Are you sure you want to disable HTTPS?
