...
variable "vm_name" {
  type    = string
  default = "openthinclient-Appliance-2025.2.1"
}
...
variable "iso_checksum" {
  type    = string
  default = "cb089def0684fd93c9c2fbe45fd16ecc809c949a6fd0c91ee199faefe7d4b82b64658a264a13109d59f1a40ac3080be2f7bd3d8bf3e9cdf509add6d72576a79b"
}
...
variable "iso_urls" {
  ...
  default = [
    ...
    "https://cdimage.debian.org/cdimage/archive/12.10.0/amd64/iso-cd/debian-12.10.0-amd64-netinst.iso"
  ]
}
