...
variable "iso_checksum" {
  type    = string
  default = "cf824084643fb82f74d1fbec804baaf74539dadd279af2098da94254f758e5b7"
}

variable "iso_url" {
  type    = string
  default = "https://cdimage.debian.org/cdimage/archive/10.10.0/i386/iso-cd/debian-10.10.0-i386-netinst.iso"
}
...
build {
  sources = ["source.virtualbox-iso.vbox", "source.vmware-iso.vmware"]
