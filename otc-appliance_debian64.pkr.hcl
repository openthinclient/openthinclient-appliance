...
build {
  ...
  provisioner "shell" {
    ...
    scripts          = ["scripts/networking.sh", "scripts/openthinclient-installer.sh", "scripts/openthinclient-custom.sh", "scripts/openthinclient-gui.sh", "scripts/vmtools.sh", "scripts/motd.sh", "scripts/print-server.sh", "scripts/openthinclient-cleaner.sh", "scripts/minimize.sh"]
  }
